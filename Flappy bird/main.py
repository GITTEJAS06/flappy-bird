...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] = pygame.image.load('gallery/pictures/message.png').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load('gallery/pictures/base.png').convert_alpha()
    pipe_image = pygame.image.load(PIPE).convert_alpha()
    GAME_SPRITES['pipe'] = (pygame.transform.rotate(pipe_image, 180), pipe_image)
    ...
    GAME_SOUNDS['point'] = pygame.mixer.Sound('gallery/music/point.wav')
